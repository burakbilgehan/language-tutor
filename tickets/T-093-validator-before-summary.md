...
Generated 2026-08-10T20:31:51.572Z from `data/t093-snapshot.db` (snapshot mtime 2026-08-10T20:31:36.770Z).
Read-only sweep; the validator opens the DB with `readonly: true` and changes nothing.
Machine-readable work list: `tickets/T-093-validator-before.json` (22769 findings).
