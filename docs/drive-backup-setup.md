...
> **No longer applies.** The Google Drive backup feature documented here was
> removed in [T-050](../tickets/T-050-remove-drive-backup.md) and replaced by
> cloud save-sync ([T-047](../tickets/T-047-cloud-save-sync.md), Google
> sign-in + R2). This page is kept for historical reference only; none of the
> setup steps below are needed anymore.
