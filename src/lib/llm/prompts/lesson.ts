...
- İyi soru kalıpları (örnek): "Bu 4 kanadan hangisi 'nu' okunur?" (benzer görünümlüler arasından: ぬ/め/ね/わ), "Hangisi な satırından DEĞİLDİR?", karışık bir listeden belirli sesi/harfi ayıklatma. Kötü kalıp (yasak): "X satırındaki harfleri sırasıyla yaz" — ezberlenmiş dizi, hiçbir şey ölçmez.`
      : `- CEVABI YAZIMDAN OKUNAN SORU YASAK: "Hangisinde X sesi var/yok?", "X harfi nasıl okunur?" gibi sorular cevabı kelimenin yazımında zaten gösterir, hiçbir şey ölçmez; harf/ses ayıklatma kalıbı KURMA. Telaffuz KONUSU yasak değildir: gerçek bir zorluk varsa (ör. hangi harf birleşimi beklenmedik okunur, ana dilde olmayan sesler) açıklama metninde öğret; sadece yazımdan cevaplanabilen soruya çevirme.
